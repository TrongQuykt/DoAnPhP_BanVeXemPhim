<div class="container mt-5 w-75">
            ...
            <a href="views/detail-content.php?id=<?= $item['Id'] ?>" class="card-link">
                <div class="hover-zoom d-flex mb-2">
                    <?php
                                ...
                                if (!empty($anhArray[0])) {
                                    $anh = trim($anhArray[0]);
                                    echo '<img src="/BanVeXemPhim/uploads/content-imgs/' . htmlspecialchars($anh) . '" class="card-img-top w-50 rounded" alt="Article image">';
                                }
                                ?>
    ...
    <div class="text-center mt-4">
        <a href="views/list-content-all.php" type="button" class="btn-neon" >Xem thêm</a>
    </div>
</div>
<style>
            .btn-neon {
