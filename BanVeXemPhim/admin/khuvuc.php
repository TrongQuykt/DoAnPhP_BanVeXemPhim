...
$pagination = setupPagination($conn, 'khuvuc', $records_per_page, $searchString);
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center pb-0">
                ...
                <a href="views/khuvuc/khuvuc-add.php" class="btn btn-lg me-5 btn-add"
                    ...
                    <table class="table table-striped table-borderless align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-xs font-weight-bolder">Tên khu vực</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center text-xs font-weight-bolder"><?= $row['MoTa'] ?></td>
                                        <td class="text-center text-s font-weight-bolder">
                                            <form action="controllers/khuvuc-controller.php" method="POST" style="display:inline;">
                                                <input type="hidden" name="makhuvuc" value="<?= $row['MaKhuVuc'] ?>">
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <a class="btn btn-info m-0"
                                                ...
                                                href="views/khuvuc/khuvuc-edit.php?id=<?= $row['MaKhuVuc'] ?>">
                                                <i class="bi bi-pencil"></i> Sửa
                                            </a>
                                            <a class="btn btn-danger m-0 delete-btn" data-id="<?= $row['MaKhuVuc'] ?>"
                                                data-url="controllers/khuvuc-controller.php?action=delete"
                                                style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"
