<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/BanVeXemPhim/admin/index.php" target="_blank">
            <span class="ms-1 font-weight-bold fs-4 font-monospace">
                <img src="/BanVeXemPhim/assets/imgs/logo1.jpeg" class="w-25 bg-dark"
                    alt="Dashboard">
                DashBoard</span>
        </a>
    </div>
    ...
    $base_pages = [
        'dashboard' => ['index.php'],
        "doan" => ['combo.php', 'combo-add.php', 'combo-edit.php', 'combo-detail.php'],
        "khuvuc" => ['khuvuc.php', 'khuvuc-add.php', 'khuvuc-edit.php'],
        "rapchieuphim" => ['comrapchieuphimbo.php', 'rapchieuphim-add.php', 'rapchieuphim-edit.php'],
        ...
        <ul class="navbar-nav" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
                <a class="nav-link <?php if (isActive($current_page, $base_pages, 'dashboard') || $current_page == 'admin') echo 'active'; ?>"
                    href="/BanVeXemPhim/admin/index.php" data-class="bg - transparent">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link <?php if (isActive($current_page, $base_pages, 'doan')) echo 'active'; ?>"
                    href="/BanVeXemPhim/admin/combo.php" data-class="bg-white">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if (isActive($current_page, $base_pages, 'room')) echo 'active'; ?>"
                    href="/BanVeXemPhim/admin/room.php" data-class="bg-white">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-filter-square" viewBox="0 0 16 16">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if (isActive($current_page, $base_pages, 'chair')) echo 'active'; ?>"
                    href="/BanVeXemPhim/admin/chair.php" data-class="bg-white">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if (isActive($current_page, $base_pages, 'khuvuc')) echo 'active'; ?>"
                    href="/BanVeXemPhim/admin/khuvuc.php" data-class="bg-white">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-filter-square" viewBox="0 0 16 16">
                    ...
                    <span class="nav-link-text ms-1">Danh sách khu vực</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php if (isActive($current_page, $base_pages, 'rapchieuphim')) echo 'active'; ?>"
                    href="/BanVeXemPhim/admin/rapchieuphim.php" data-class="bg-white">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-filter-square" viewBox="0 0 16 16">
                    ...
                    <span class="nav-link-text ms-1">Danh sách rạp chiếu phim</span>
                </a>
            </li>
                ...
                <ul class="nav nav-treeview <?php echo (isActive($current_page, $base_pages, 'categories') || isActive($current_page, $base_pages, 'film') || isActive($current_page, $base_pages, 'room') || isActive($current_page, $base_pages, 'chair') || isActive($current_page, $base_pages, 'showtime')) ? 'show' : 'collapse'; ?>"
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if (isActive($current_page, $base_pages, 'categories')) echo 'active'; ?>"
                            href="/BanVeXemPhim/admin/categories.php" data-class="bg-white">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if (isActive($current_page, $base_pages, 'film')) echo 'active'; ?>"
                            href="/BanVeXemPhim/admin/film.php" data-class="bg-white">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if (isActive($current_page, $base_pages, 'showtime')) echo 'active'; ?>"
                            href="/BanVeXemPhim/admin/showtime.php" data-class="bg-white">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <ul class="nav nav-treeview <?php echo (isActive($current_page, $base_pages, 'topic') || isActive($current_page, $base_pages, 'content')) ? 'show' : 'collapse'; ?>"
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if (isActive($current_page, $base_pages, 'topic')) echo 'active'; ?>"
                            href="/BanVeXemPhim/admin/topic.php" data-class="bg-white">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if (isActive($current_page, $base_pages, 'content')) echo 'active'; ?>"
                            href="/BanVeXemPhim/admin/content.php" data-class="bg-white">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <ul class="nav nav-treeview <?php echo (isActive($current_page, $base_pages, 'slider') || isActive($current_page, $base_pages, 'menu')) ? 'show' : 'collapse'; ?>"
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if (isActive($current_page, $base_pages, 'slider')) echo 'active'; ?>"
                            href="/BanVeXemPhim/admin/slider.php" data-class="bg-white">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if (isActive($current_page, $base_pages, 'menu')) echo 'active'; ?>"
                            href="/BanVeXemPhim/admin/menu.php" data-class="bg-white">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <li class="nav-item">
                <a class="nav-link <?php if (isActive($current_page, $base_pages, 'parameter')) echo 'active'; ?>"
                    href="/BanVeXemPhim/admin/parameter.php" data-class="bg-white">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <li class="nav-item">
                <a class="nav-link <?php if (isActive($current_page, $base_pages, 'user')) echo 'active'; ?>"
                    href="/BanVeXemPhim/admin/user.php" data-class="bg-white">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if (isActive($current_page, $base_pages, 'accounts')) echo 'active'; ?>"
                    href="/BanVeXemPhim/admin/accounts.php" data-class="bg-white">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if (isActive($current_page, $base_pages, 'invoice')) echo 'active'; ?>"
                    href="/BanVeXemPhim/admin/invoice.php" data-class="bg-white">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <li class="sidenav-footer mx-3">
                <a class="btn bg-gradient-primary mt-3 w-100" href="/BanVeXemPhim/admin/logout.php">Đăng
                    xuất</a>
            </li>
        </ul>
    </div>
