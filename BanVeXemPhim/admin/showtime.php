                    ...
                    <table class="table table-striped table-borderless align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-xs font-weight-bolder">Rạp</th>
                        ...
                        <tbody>
                            ...
                            if (!empty($data)) {
                                foreach ($data as $item) {
                                    ...
                                    $rap = getByID('rapchieuphim', 'MaRap', $item['MaRap']);
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <th class="text-center text-xs font-weight-bolder"><?= $khuVuc['data']['TenKhuVuc']; ?></th>
                                        <th class="text-center text-xs font-weight-bolder"><?= $rap['data']['TenRap']; ?></th>
                                        <th class="text-center text-xs font-weight-bolder"><?= $phong['data']['TenPhong']; ?></th>
