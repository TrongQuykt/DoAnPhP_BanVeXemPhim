                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="loaighe" name="loaighe" required>
                            ...
                            <option value="Silver" <?= $item['data']['LoaiGhe'] == 'Silver' ? 'selected' : ''; ?>>Silver</option>
                            <option value="Gold" <?= $item['data']['LoaiGhe'] == 'Gold' ? 'selected' : ''; ?>>Gold</option>
                            <option value="Platinum" <?= $item['data']['LoaiGhe'] == 'Platinum' ? 'selected' : ''; ?>>Platinum</option>
                        </select>
                    </div>
                    <div class="col-md-6">
