...
if (isset($_SESSION['lastActivity']) && (time() - $_SESSION['lastActivity'] > $inactiveLimit)) {
    ...
    if (isset($_SESSION['role']) && $_SESSION['role'] === 'user') {
        redirect('/BanVeXemPhim/views/login.php', 'error', 'Quá phiên đăng nhập! Vui lòng đăng nhập lại');
    }
}
...
<script>
    ...
    window.onload = function() {
        ...
        <?php if (isset($_SESSION['session_expired']) && $_SESSION['session_expired'] === true): ?>
            ...
            if (userRole === 'admin') {
                ...
                window.location.href = '/BanVeXemPhim/admin/sign-in.php';
            } else {
                window.location.href = '/BanVeXemPhim/views/login.php';
            }
    ...
    function createSessionExpiredModal() {
        ...
        loginButton.href = userRole === 'admin' ? '/BanVeXemPhim/admin/sign-in.php' : '';
